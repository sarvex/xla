...
struct FloatTypes {
  ...
  PyObject* float8_e4m3b11 = nullptr;
  PyObject* float8_e5m2 = nullptr;

  int bfloat16_num = -1;
  int float8_e4m3fn_num = -1;
  int float8_e4m3b11_num = -1;
...
bool Initialize() {
  ...
  auto init = []() {
    ...
    float_types_.float8_e4m3b11 =
        PyObject_GetAttrString(ml_dtypes.get(), "float8_e4m3b11");
    if (!float_types_.float8_e4m3b11) {
      return false;
    }
    ...
    float_types_.float8_e4m3b11_num = PyArray_TypeNumFromName("float8_e4m3b11");
    if (float_types_.float8_e4m3b11_num == NPY_NOTYPE) {
      return false;
    }
...
PyObject* GetFloat8E4m3b11Dtype() { return float_types_.float8_e4m3b11; }
...
int GetFloat8E4m3b11TypeNum() { return float_types_.float8_e4m3b11_num; }
