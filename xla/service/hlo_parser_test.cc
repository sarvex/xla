...
R"(HloModule ConstantR1F8E4M3B11_module, entry_computation_layout={()->f8e4m3b11fnuz[3]{0}}

ENTRY %IsFiniteR1F32s.v2 () -> f8e4m3b11fnuz[3] {
  ROOT %constant = f8e4m3b11fnuz[3]{0} constant({nan, 7})
}
