...
// Abstract arguments for making a loaded host callback. Please see
// `Compiler::MakeLoadedHostCallback`.
struct LoadedHostCallbackMakeArgs
    : llvm::RTTIExtends<LoadedHostCallbackMakeArgs, llvm::RTTIRoot> {
...
// computation call are implementation speciifc.
